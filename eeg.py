...
from eegnb_utils import get_openbci_usb, create_stim_array,SAMPLE_FREQS,EEG_INDICES,EEG_CHANNELS
...
class EEG:
    ...
    def initialize_backend(self):
        if self.backend == "brainflow":
            ...
            self._init_muselsl()
            #elf._muse_get_recent() # run this at initialization to get some 
